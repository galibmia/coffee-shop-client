        ...
        <div>
            <div className=' w-full md:w-9/12 px-4 mx-auto mt-5 mb-12 flex flex-col md:flex-row gap-5 md:gap-40 justify-center md:justify-between'>
                <div className='w-full md:w-1/2'>
                    ...
                    <h1 className='text-[#331A15] text-5xl rancho-regular mt-8'>Get in Touch</h1>
                    <div className='mt-8'>
                ...
                <div className='w-full md:w-2/5 mt-5 md:mt-24'>
                    <h1 className='text-[#331A15] text-5xl rancho-regular mt-6'>Connect with Us</h1>
                    <form>
                        <input className='w-full md:w-4/5 p-3 custom-border mt-8' type="text" placeholder='Name' />
                        <input className='w-full md:w-4/5 p-3 mt-8 custom-border' type="email" placeholder='Email' />
                        <textarea className='w-full md:w-4/5 p-3 mt-8 custom-border text-area' name="message"  placeholder='Message' id=""></textarea>
                        <button className='rancho-regular mt-8 w-full md:w-1/2 border-2 border-[#331A15] rounded-full text-2xl'>Send Message</button>
                    </form>
                </div>
            </div>
